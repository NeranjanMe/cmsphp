...
$pageTitle = "Generate Blog Post Title";
include '../include/dashboard_header.php';
?>

<?php include '../include/dashboard_slidenav_head.php'; ?>

<h1 class="mt-4">Generate Blog Post Title</h1>
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
    <li class="breadcrumb-item active">Generate Blog Post Title</li>
</ol>
<div class="card mb-4 mt-5">
    <div class="card-body">
        <form id="generate-content-form">
            <label for="title">Enter the Keyword:</label><br>
...
$(document).ready(function(){
    $("#generate-content-form").submit(function(e){
        ...
        $.ajax({
        url: '../generate/generate_blog_title.php',
        type: 'post',
